...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mReaperLogo;
    ...
    public void init() {
        ...
        mReaperLogo = mView.findViewById(R.id.reaper_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mReaperLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mReaperLogo.setAlpha(newAlphaBC);
        }
    }
}
