...
LOCAL_FULL_LIBS_MANIFEST_FILES := frameworks/opt/reaper/packages/SlimSystemUI/AndroidManifest.xml
LOCAL_SRC_FILES += $(call all-java-files-under, ../../../opt/reaper/packages/SlimSystemUI/src)
LOCAL_RESOURCE_DIR += frameworks/opt/cards/res frameworks/opt/reaper/packages/SlimSystemUI/res
